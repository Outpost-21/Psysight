...
namespace Psysight
{
    [HarmonyPatch(typeof(StatPart_SightPsychicSenstivityOffset), "TryGetPsychicOffset")]
    public static class Patch_StatPart_SightPsychicSenstivityOffset_TryGetPsychicOffset
    {
        [HarmonyPostfix]
        public static void Postfix(StatPart_SightPsychicSenstivityOffset __instance, ref bool __result, Thing t, out float offset)
        {
            Pawn pawn;
